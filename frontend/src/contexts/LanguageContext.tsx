...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'question.presentAddress.houseNo': 'What is your house/building/apartment number?',
    'question.presentAddress.streetArea': 'What is your street/area/locality/mohalla/road?',
    'question.presentAddress.townVillage': 'What is your town/village name?',
    'question.presentAddress.postOffice': 'What is your post office name?',
    'question.presentAddress.pinCode': 'What is your PIN code?',
    'question.presentAddress.tehsilTaluka': 'What is your tehsil/taluka/mandal name?',
    'question.presentAddress.district': 'What is your district name?',
    'question.presentAddress.stateUt': 'What is your state/UT name?',
    'question.declarationDate':'Enter declaration date',
    'question.declarationPlace':'Enter declaration place',
...
'example.presentAddress.houseNo': 'e.g., A-123, Flat 405',
    'example.presentAddress.streetArea': 'e.g., Main Street, Sector 15',
    'example.presentAddress.townVillage': 'e.g., Delhi, Mumbai',
    'example.presentAddress.postOffice': 'e.g., Central Post Office',
    'example.presentAddress.pinCode': 'e.g., 110001',
    'example.presentAddress.tehsilTaluka': 'e.g., Central Delhi',
    'example.presentAddress.district': 'e.g., New Delhi',
    'example.presentAddress.stateUt': 'e.g., Delhi, Maharashtra',
    // Application types
...
'question.presentAddress.houseNo': 'आपका घर/भवन/अपार्टमेंट संख्या क्या है?',
    'question.presentAddress.streetArea': 'आपकी सड़क/क्षेत्र/मोहल्ला/सड़क का नाम क्या है?',
    'question.presentAddress.townVillage': 'आपके शहर/गाँव का नाम क्या है?',
    'question.presentAddress.postOffice': 'आपके डाकघर का नाम क्या है?',
    'question.presentAddress.pinCode': 'आपका पिन कोड क्या है?',
...
'example.presentAddress.houseNo': 'उदा., A-123, फ्लैट 405',
    'example.presentAddress.streetArea': 'उदा., मुख्य सड़क, सेक्टर 15',
    'example.presentAddress.townVillage': 'उदा., दिल्ली, मुंबई',
    'example.presentAddress.postOffice': 'उदा., केंद्रीय डाकघर',
    'example.presentAddress.pinCode': 'उदा., 110001',
    'example.presentAddress.tehsilTaluka': 'उदा., केंद्रीय दिल्ली',
    'example.presentAddress.district': 'उदा., नई दिल्ली',
    'example.presentAddress.stateUt': 'उदा., दिल्ली, महाराष्ट्र',
  ...
  'question.presentAddress.houseNo': 'আপনার বাড়ি/ভবন/অ্যাপার্টমেন্ট নম্বর কী?',
    'question.presentAddress.streetArea': 'আপনার রাস্তা/এলাকা/পাড়া/রোডের নাম কী?',
    'question.presentAddress.townVillage': 'আপনার শহর/গ্রামের নাম কী?',
    'question.presentAddress.postOffice': 'আপনার ডাকঘরের নাম কী?',
    'question.presentAddress.pinCode': 'আপনার পিন কোড কী?',
    ...
    'button.stop': 'বন্ধ করুন',
     'example.presentAddress.houseNo': 'উদা., A-123, ফ্ল্যাট 405',
    'example.presentAddress.streetArea': 'উদা., মেইন স্ট্রিট, সেক্টর 15',
    'example.presentAddress.townVillage': 'উদা., দিল্লি, মুম্বাই',
    'example.presentAddress.postOffice': 'উদা., সেন্ট্রাল পোস্ট অফিস',
    'example.presentAddress.pinCode': 'উদা., 110001',
    'example.presentAddress.tehsilTaluka': 'উদা., সেন্ট্রাল দিল্লি',
    'example.presentAddress.district': 'উদা., নিউ দিল্লি',
    'example.presentAddress.stateUt': 'উদা., দিল্লি, মহারাষ্ট্র',
